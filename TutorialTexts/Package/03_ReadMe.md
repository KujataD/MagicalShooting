...
9. 書いたときの例です。テンプレートを埋めるとこうなります。
   ...
   ## まとめPV用の説明とタイトルコール
   - 50文字以内の説明：制限時間内にゴールを目指す2D迷路ゲーム。アイテムを取って時間を延ばそう
   - タイトルコール：迷路ダッシュ！
...
9. 各項目が何に使われるかを知っておくと、書く内容に迷いません。
   ...
   | まとめPV用の説明とタイトルコール | 全チームのミニゲームを紹介するまとめPVで、そのまま**ナレーションやテロップ**に使います |
...
14. 書くときの注意は3つです。
    ...
    - まとめPV用の説明は**50文字以内**。長いとテロップに入りきりません。タイトルコールは短く、読み上げやすい形にします（例：「迷路ダッシュ！」）
